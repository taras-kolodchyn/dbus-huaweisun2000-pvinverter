    ...
    GradientListView {
        ...
        delegate: ListQuantityGroupNavigation {
            ...
            readonly property real displayVoltage: _usePvInverterAcFallback && _acVoltage.valid
                    ? _acVoltage.value
                    : voltage
            readonly property real displayCurrent: _usePvInverterAcFallback && _acCurrent.valid
                    ? _acCurrent.value
                    : current
            ...
            quantityModel: QuantityObjectModel {
                ...
                QuantityObject { object: solarInputDelegate; key: "displayVoltage"; unit: VenusOS.Units_Volt_DC }
                QuantityObject { object: solarInputDelegate; key: "displayCurrent"; unit: VenusOS.Units_Amp }
            ...
            VeQuickItem {
                id: _acVoltage
                uid: solarInputDelegate.serviceType === "pvinverter"
                        ? solarInputDelegate.serviceUid + "/Ac/Voltage"
                        : ""
            }
            ...
            VeQuickItem {
                id: _acCurrent
                uid: solarInputDelegate.serviceType === "pvinverter"
                        ? solarInputDelegate.serviceUid + "/Ac/Current"
                        : ""
            }
        }
