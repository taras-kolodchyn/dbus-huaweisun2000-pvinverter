...
RunningStatus = {0: "offline", 1: "standby", 2: "running", 3: "fault", 4: "sleep mode"}
...
ProductModel = {0: "None", 1: "LG-RESU", 2: "HUAWEI-LUNA2000"}
...
ChargeFromGridFunction = {0: "Disable", 1: "Enable"}

ForcibleChargeDischarge = {0: "Stop", 1: "Charge", 2: "Discharge"}

ForcibleChargeDischargeSettingMode = {0: "Duration"}

ExcessPVEnergyUseInTOU = {0: "Fed to grid", 1: "Charge"}

SwitchToOffGrid = {0: "Switch from grid-tied to off-grid"}

VoltageIndependentOperation = {0: "101 V", 1: "202 V"}

MeterStatus = {0: "offline", 1: "online"}

MeterType = {0: "single-phase", 1: "three-phase"}
