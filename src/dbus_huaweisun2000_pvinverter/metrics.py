...
DERIVED_SERVICE_METRICS = {
    ...
    "/Yield/Power": _metric(0, formatter="w"),
    "/Pv/V": _metric(0, formatter="v"),
    "/Pv/I": _metric(0, formatter="a"),
    "/Dc/0/Voltage": _metric(0, formatter="v"),
    "/Dc/0/Current": _metric(0, formatter="a"),
